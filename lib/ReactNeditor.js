...
function (_React$Component) {
  _inherits(ReactNeditor, _React$Component);

  function ReactNeditor(props) {
    var _this;

    _classCallCheck(this, ReactNeditor);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactNeditor).call(this, props));
  ...
  _createClass(ReactNeditor, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      var neditorPath = this.props.neditorPath;

      if (!window.UE && !window.UE_LOADING_PROMISE) {
        window.UE_LOADING_PROMISE = this.createScript(neditorPath + '/neditor.config.js').then(function () {
          return _this2.props.debug ? _this2.createScript(neditorPath + '/neditor.all.js') : _this2.createScript(neditorPath + '/neditor.all.min.js');
        }).then(function () {
          return _this2.createScript(neditorPath + '/neditor.service.js');
        }).then(function () {
          return _this2.props.debug ? _this2.createScript(neditorPath + '/neditor.parse.js') : _this2.createScript(neditorPath + '/neditor.parse.min.js');
        }).then(function () {
          return _this2.createScript(neditorPath + '/third-party/jquery-1.10.2.min.js');
        });
      }
...
_defineProperty(ReactNeditor, "propTypes", {
  value: _propTypes["default"].string,
  neditorPath: _propTypes["default"].string.isRequired,
...
_defineProperty(ReactNeditor, "defaultProps", {
  value: '',
